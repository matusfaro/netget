...
SETUP (one-time):
  ...
  3. Install Rust and required tools:
     $ pkg install rust git clang binutils make perl cmake protobuf

     Note: make, perl, cmake, and protobuf are needed for compiling OpenSSL and other dependencies from source
