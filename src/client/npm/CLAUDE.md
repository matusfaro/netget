...
The NPM Registry client allows LLM-controlled interaction with the NPM package registry (registry.npmjs.org or custom registries). It provides package search, metadata retrieval, and tarball download capabilities.
