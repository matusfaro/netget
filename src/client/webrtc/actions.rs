...
impl Client for WebRtcClientProtocol {
    ...
    fn get_async_actions(&self, _state: &AppState) -> Vec<ActionDefinition> {
        vec![
            ...
            ActionDefinition {
                ...
                description: "Apply the SDP answer from the remote peer to complete connection".to_string(),
                parameters: vec![
                    Parameter {
    ...
    fn execute_action(&self, action: serde_json::Value) -> Result<ClientActionResult> {
        ...
        match action_type {
            ...
            _ => Err(anyhow::anyhow!("Unknown WebRTC client action: {}", action_type)),
        }
    }
    ...
    fn keywords(&self) -> Vec<&'static str> {
        vec!["webrtc", "webrtc client", "data channel", "peer to peer", "p2p"]
    }
