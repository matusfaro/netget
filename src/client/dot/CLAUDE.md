...
The DoT client provides LLM-controlled DNS query capabilities over TLS-encrypted connections, implementing RFC 7858. It connects to DoT servers (typically on port 853) and allows the LLM to construct and send DNS queries while interpreting responses.
