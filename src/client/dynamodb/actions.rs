...
impl Client for DynamoDbClientProtocol {
            ...
            ActionDefinition {
                ...
                parameters: vec![
                    ...
                    Parameter {
                        name: "item".to_string(),
                        type_hint: "object".to_string(),
                        description: "Item to put (map of attribute names to values with types)".to_string(),
                        required: true,
                    },
                ],
                example: json!({
            ...
            ActionDefinition {
                ...
                parameters: vec![
                    ...
                    Parameter {
                        name: "key".to_string(),
                        type_hint: "object".to_string(),
                        description: "Primary key of the item (map of attribute names to values with types)".to_string(),
                        required: true,
                    },
                ],
                example: json!({
    ...
    fn execute_action(&self, action: serde_json::Value) -> Result<ClientActionResult> {
        ...
        match action_type {
            ...
            _ => Err(anyhow::anyhow!("Unknown DynamoDB client action: {}", action_type)),
        }
    }
    ...
    fn get_event_types(&self) -> Vec<EventType> {
        vec![
            EventType {
                id: "dynamodb_connected".to_string(),
                description: "Triggered when DynamoDB client is initialized".to_string(),
                actions: vec![],
                parameters: vec![],
            },
            EventType {
                id: "dynamodb_response_received".to_string(),
                description: "Triggered when DynamoDB client receives a response".to_string(),
                actions: vec![],
                parameters: vec![],
            },
        ]
