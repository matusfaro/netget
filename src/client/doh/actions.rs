...
impl Client for DohClientProtocol {
            ...
            ActionDefinition {
                ...
                parameters: vec![
                    ...
                    Parameter {
                        ...
                        type_hint: "string".to_string(),
                        description: "DNS record type: A, AAAA, MX, TXT, CNAME, NS, SOA, PTR, SRV, etc.".to_string(),
                        required: false,
                    },
                    Parameter {
                        name: "use_get".to_string(),
                        type_hint: "boolean".to_string(),
                        description: "Use HTTP GET method instead of POST (default: false)".to_string(),
                        required: false,
                    },
                ],
                example: json!({
    ...
    fn execute_action(&self, action: serde_json::Value) -> Result<ClientActionResult> {
        ...
        match action_type {
            ...
            _ => Err(anyhow::anyhow!("Unknown DoH client action: {}", action_type)),
        }
    }
    ...
    fn keywords(&self) -> Vec<&'static str> {
        vec!["doh", "dns-over-https", "doh client", "dns client", "secure dns"]
    }
