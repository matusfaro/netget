...
impl Client for Socks5ClientProtocol {
    ...
    fn get_startup_parameters(&self) -> Vec<ParameterDefinition> {
        vec![
            ParameterDefinition {
                name: "target_addr".to_string(),
                description: "Target server address to connect through SOCKS5 proxy (host:port)".to_string(),
                type_hint: "string".to_string(),
                required: true,
    ...
    fn execute_action(&self, action: serde_json::Value) -> Result<ClientActionResult> {
        ...
        match action_type {
            ...
            _ => Err(anyhow::anyhow!("Unknown SOCKS5 client action: {}", action_type)),
        }
    }
    ...
    fn get_event_types(&self) -> Vec<EventType> {
        vec![
            EventType {
                ...
                description: "Triggered when SOCKS5 client connects through proxy to target".to_string(),
                actions: vec![],
                parameters: vec![],
            },
            EventType {
                id: "socks5_data_received".to_string(),
                description: "Triggered when SOCKS5 client receives data from target server".to_string(),
                actions: vec![],
                parameters: vec![],
            },
        ]
    ...
    fn keywords(&self) -> Vec<&'static str> {
        vec!["socks5", "socks", "proxy", "socks5 client", "connect via socks5"]
    }
    ...
    fn metadata(&self) -> crate::protocol::metadata::ProtocolMetadataV2 {
        ...
        ProtocolMetadataV2::builder()
            ...
            .llm_control("Full control over target address, authentication, and data flow through proxy")
