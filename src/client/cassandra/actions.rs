...
impl Protocol for CassandraClientProtocol {
                ...
                ActionDefinition {
                    ...
                    parameters: vec![
                        Parameter {
                            ...
                            type_hint: "string".to_string(),
                            description: "CQL query (e.g., SELECT * FROM keyspace.table WHERE id = 1)".to_string(),
                            required: true,
                        },
                        Parameter {
        ...
        fn keywords(&self) -> Vec<&'static str> {
            vec!["cassandra", "cassandra client", "connect to cassandra", "cql", "scylla"]
        }
...
impl Client for CassandraClientProtocol {
        ...
        fn execute_action(&self, action: serde_json::Value) -> Result<ClientActionResult> {
            ...
            match action_type {
                ...
                _ => Err(anyhow::anyhow!("Unknown Cassandra client action: {}", action_type)),
            }
        }
}
