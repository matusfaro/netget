...
pub static RIP_CLIENT_RESPONSE_RECEIVED_EVENT: LazyLock<EventType> = LazyLock::new(|| {
    ...
    .with_parameters(vec![
        ...
        Parameter {
            ...
            description: "Array of route entries with ip_address, subnet_mask, next_hop, and metric".to_string(),
            required: true,
        },
    ])
});
        ...
        fn get_event_types(&self) -> Vec<EventType> {
            vec![
                ...
                EventType {
                    ...
                    description: "Triggered when RIP client receives routing table response".to_string(),
                    actions: vec![],
                    parameters: vec![],
                },
            ]
...
impl Client for RipClientProtocol {
        ...
        fn execute_action(&self, action: serde_json::Value) -> Result<ClientActionResult> {
            ...
            match action_type {
                ...
                _ => Err(anyhow::anyhow!("Unknown RIP client action: {}", action_type)),
            }
        }
}
