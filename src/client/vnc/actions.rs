                ...
                ActionDefinition {
                    ...
                    parameters: vec![
                        ...
                        Parameter {
                            ...
                            type_hint: "number".to_string(),
                            description: "Button mask (0=no buttons, 1=left, 2=middle, 4=right)".to_string(),
                            required: true,
                        },
                    ],
                    example: json!({
        ...
        fn execute_action(&self, action: serde_json::Value) -> Result<ClientActionResult> {
            ...
            match action_type {
                "request_framebuffer_update" => {
                    let incremental = action.get("incremental")
                ...
                "send_pointer_event" => {
                    ...
                    let button_mask = action.get("button_mask")
                        .and_then(|v| v.as_u64())
                        .context("Missing or invalid 'button_mask' field")? as u8;
                ...
                _ => Err(anyhow::anyhow!("Unknown VNC client action: {}", action_type)),
            }
        }
}
