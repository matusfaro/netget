...
impl Protocol for BitcoinClientProtocol {
        ...
        fn get_async_actions(&self, _state: &AppState) -> Vec<ActionDefinition> {
            vec![
                ...
                ActionDefinition {
                    ...
                    description: "Get blockchain information (chain, blocks, difficulty, etc.)".to_string(),
                    parameters: vec![],
                    example: json!({
                ...
                ActionDefinition {
                    ...
                    parameters: vec![
                        ...
                        Parameter {
                            ...
                            type_hint: "number".to_string(),
                            description: "Verbosity level (0=hex, 1=json, 2=json with tx details)".to_string(),
                            required: false,
                        },
                    ],
                    example: json!({
                ...
                ActionDefinition {
                    ...
                    description: "Get mining information (network hashrate, difficulty, etc.)".to_string(),
                    parameters: vec![],
                    example: json!({
                ...
                ActionDefinition {
                    ...
                    description: "Get network information (version, connections, protocols, etc.)".to_string(),
                    parameters: vec![],
                    example: json!({
        ...
        fn keywords(&self) -> Vec<&'static str> {
            vec!["bitcoin", "btc", "bitcoin rpc", "bitcoin client", "blockchain"]
        }
        fn metadata(&self) -> crate::protocol::metadata::ProtocolMetadataV2 {
            ...
            ProtocolMetadataV2::builder()
                ...
                .llm_control("Full control over Bitcoin RPC commands (blockchain, wallet, network queries)")
...
impl Client for BitcoinClientProtocol {
        ...
        fn execute_action(&self, action: serde_json::Value) -> Result<ClientActionResult> {
            ...
            match action_type {
                ...
                _ => Err(anyhow::anyhow!("Unknown Bitcoin RPC client action: {}", action_type)),
            }
        }
}
