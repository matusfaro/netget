...
impl Client for NntpClientProtocol {
    ...
    fn get_async_actions(&self, _state: &AppState) -> Vec<ActionDefinition> {
        vec![
            ActionDefinition {
                ...
                parameters: vec![
                    Parameter {
                        ...
                        type_hint: "string".to_string(),
                        description: "Name of the newsgroup to select (e.g., comp.lang.rust)".to_string(),
                        required: true,
                    },
                ],
                example: json!({
            ...
            ActionDefinition {
                ...
                parameters: vec![
                    Parameter {
                        ...
                        type_hint: "string".to_string(),
                        description: "Article number or message-id (e.g., '123' or '<msg@example.com>')".to_string(),
                        required: true,
                    },
                ],
                example: json!({
            ...
            ActionDefinition {
                ...
                parameters: vec![
                    Parameter {
                        ...
                        description: "Article headers (From, Newsgroups, Subject, etc.)".to_string(),
                        required: true,
                    },
                    Parameter {
                        name: "body".to_string(),
            ...
            ActionDefinition {
                ...
                description: "Get article status without retrieving content (STAT command)".to_string(),
                parameters: vec![
                    Parameter {
                        name: "article_id".to_string(),
                        type_hint: "string".to_string(),
    ...
    fn execute_action(&self, action: serde_json::Value) -> Result<ClientActionResult> {
        ...
        match action_type {
            ...
            _ => Err(anyhow::anyhow!("Unknown NNTP client action: {}", action_type)),
        }
    }
    ...
    fn get_event_types(&self) -> Vec<EventType> {
        vec![
            EventType {
                id: "nntp_connected".to_string(),
                description: "Triggered when NNTP client connects to server".to_string(),
                actions: vec![],
                parameters: vec![],
            },
            EventType {
                id: "nntp_response_received".to_string(),
                description: "Triggered when NNTP client receives a response".to_string(),
                actions: vec![],
                parameters: vec![],
            },
        ]
