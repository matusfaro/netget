...
impl Protocol for XmppClientProtocol {
        ...
        fn get_sync_actions(&self) -> Vec<ActionDefinition> {
            vec![
                ActionDefinition {
                    name: "send_message".to_string(),
                    description: "Send a message in response to a received message or event".to_string(),
                    parameters: vec![
                        Parameter {
                            name: "to".to_string(),
                            type_hint: "string".to_string(),
        ...
        fn keywords(&self) -> Vec<&'static str> {
            vec!["xmpp", "xmpp client", "jabber", "connect to xmpp", "connect to jabber"]
        }
...
impl Client for XmppClientProtocol {
        ...
        fn execute_action(&self, action: serde_json::Value) -> Result<ClientActionResult> {
            ...
            match action_type {
                ...
                _ => Err(anyhow::anyhow!("Unknown XMPP client action: {}", action_type)),
            }
        }
}
