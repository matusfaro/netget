...
MySQL server implementing MySQL 5.7+ wire protocol using the `opensrv-mysql` crate. The server handles prepared statements, query execution, and DDL/DML operations with full LLM control over query responses.
