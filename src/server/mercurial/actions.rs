        ...
        fn get_sync_actions(&self) -> Vec<ActionDefinition> {
            vec![
                ...
                ActionDefinition {
                    ...
                    description: "Provide key-value mappings for a namespace (bookmarks, tags, etc.)".to_string(),
                    parameters: vec![Parameter {
                        name: "keys".to_string(),
                        type_hint: "object".to_string(),
                ...
                ActionDefinition {
                    ...
                    description: "Send a Mercurial bundle (changegroup) for clone/pull operations".to_string(),
                    parameters: vec![
                        Parameter {
...
impl Server for MercurialProtocol {
        ...
        fn execute_action(&self, action: Value) -> Result<ActionResult> {
            ...
            match action_type {
                ...
                "hg_heads" => {
                    let heads = action.get("heads").ok_or_else(|| anyhow!("Missing heads"))?;
                ...
                "hg_branchmap" => {
                    let branches = action.get("branches").ok_or_else(|| anyhow!("Missing branches"))?;
