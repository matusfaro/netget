...
impl Protocol for BluetoothBleThermometerProtocol {
    ...
    fn metadata(&self) -> crate::protocol::metadata::ProtocolMetadataV2 {
        ...
        ProtocolMetadataV2::builder()
            ...
            .implementation("BLE Health Thermometer (0x1809)")
            .llm_control("Actions: set_temperature")
            .e2e_testing("Requires BLE device")
            .notes("Standard GATT Thermometer Service")
            .build()
    }
    fn description(&self) -> &'static str {
        "BLE Health Thermometer - temperature monitoring"
    }
    fn example_prompt(&self) -> &'static str {
        "Act as a thermometer at 37°C body temperature"
    }
...
impl Server for BluetoothBleThermometerProtocol {
    ...
    fn execute_action(&self, action: serde_json::Value) -> Result<ActionResult> {
        ...
        match action_type {
            "set_temperature" => Ok(ActionResult::Custom {
                name: action_type.to_string(),
                data: action,
            }),
            _ => Err(anyhow::anyhow!(
                "Unknown thermometer action: {}",
                action_type
            )),
        }
    }
