...
OpenID Connect (OIDC) is an authentication layer built on top of OAuth 2.0. This implementation provides a fully LLM-controlled OIDC provider that can handle all standard OIDC endpoints and flows.
...
The Rust ecosystem lacks mature OIDC **provider** libraries. Available libraries focus on OIDC **clients** (relying parties):
