...
impl Protocol for BluetoothBleFileTransferProtocol {
    fn get_startup_parameters(&self) -> Vec<ParameterDefinition> {
        vec![
            ParameterDefinition {
                ...
                description: "File transfer device name for advertising (default: NetGet-FileTransfer)".to_string(),
                required: false,
    ...
    fn metadata(&self) -> crate::protocol::metadata::ProtocolMetadataV2 {
        ...
        ProtocolMetadataV2::builder()
            ...
            .implementation("BLE File Transfer")
            .llm_control("File Transfer actions")
            .e2e_testing("Requires BLE device")
            .notes("BLE File Transfer")
            .build()
    }
    ...
    fn example_prompt(&self) -> &'static str {
        "Act as a BLE file_transfer device"
    }
