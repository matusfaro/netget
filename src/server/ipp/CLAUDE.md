...
IPP (Internet Printing Protocol) server implementing RFC 2910 (Internet Printing Protocol/1.1) over HTTP. The protocol uses HTTP POST requests to send IPP operations encoded in a binary format.
