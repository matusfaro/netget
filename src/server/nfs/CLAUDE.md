...
NFSv3 (Network File System version 3) server implementing RFC 1813. Provides RPC-based distributed filesystem where the LLM controls all file operations, directory structure, and content.
