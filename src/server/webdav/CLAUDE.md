...
WebDAV (Web Distributed Authoring and Versioning) server implementing RFC 4918. Provides file server functionality over HTTP with support for file operations, directory browsing, and locking.
