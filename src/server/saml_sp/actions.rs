...
impl crate::llm::actions::protocol_trait::Server for SamlSpProtocol {
    ...
    fn protocol_name(&self) -> &'static str { "SamlSp" }
    fn get_event_types(&self) -> Vec<crate::protocol::EventType> { Vec::new() }
    fn stack_name(&self) -> &'static str { "ETH>IP>TCP>HTTP>SAML-SP" }
