...
## Overview
End-to-end tests for NNTP (Network News Transfer Protocol) server implementation. Tests verify newsgroup listing, group selection, article retrieval, and article overview functionality using raw TCP connections.
