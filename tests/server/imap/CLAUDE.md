...
## Test Overview
Tests IMAP4rev1 server with raw TCP clients validating RFC 3501 command/response sequences, including authentication, mailbox operations, and message retrieval.
