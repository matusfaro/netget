...
## Overview
End-to-end tests for Syslog protocol server. Tests verify message parsing (RFC 3164 and RFC 5424), filtering by facility and severity, and LLM-controlled message handling.
