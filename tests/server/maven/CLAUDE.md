...
## Overview
End-to-end tests for the Maven repository protocol implementation. Tests validate Maven artifact serving using HTTP requests and optionally the real Maven CLI.
