...
const KNOWN_BROKEN: &[(&str, &[&str])] = &[
    ...
    ("Bitcoin P2P", &["SCRIPT_PLACEHOLDER"]),
    ("BLUETOOTH_BLE", &["SCRIPT_PLACEHOLDER"]),
    ("Cassandra", &["SCRIPT_PLACEHOLDER"]),
    ("CoAP", &["SCRIPT_PLACEHOLDER"]),
    ("CouchDB", &["SCRIPT_PLACEHOLDER"]),
    ("DataLink", &["SCRIPT_PLACEHOLDER"]),
    ("Db2", &["SCRIPT_PLACEHOLDER"]),
    ("DC", &["SCRIPT_PLACEHOLDER"]),
    ("Elasticsearch", &["SCRIPT_PLACEHOLDER"]),
    ("etcd", &["SCRIPT_PLACEHOLDER"]),
    ("FTP", &["SCRIPT_PLACEHOLDER"]),
    ("HLS", &["SCRIPT_PLACEHOLDER"]),
    ("HTTP2", &["SCRIPT_PLACEHOLDER"]),
    ("ICMP", &["SCRIPT_PLACEHOLDER"]),
    ("IGMP", &["SCRIPT_PLACEHOLDER"]),
    ("IPP", &["SCRIPT_PLACEHOLDER"]),
    ("IPSec/IKEv2", &["SCRIPT_PLACEHOLDER"]),
    ("ISIS", &["SCRIPT_PLACEHOLDER"]),
    ("LDAP", &["SCRIPT_PLACEHOLDER"]),
    ("Maven", &["SCRIPT_PLACEHOLDER"]),
    ("Modbus", &["SCRIPT_PLACEHOLDER"]),
    ("MongoDB", &["SCRIPT_PLACEHOLDER"]),
    ("MSSQL", &["SCRIPT_PLACEHOLDER"]),
    ("NAMED_PIPE", &["SCRIPT_PLACEHOLDER"]),
    ("nfc", &["SCRIPT_PLACEHOLDER"]),
    ("NFS", &["SCRIPT_PLACEHOLDER"]),
    ("OAuth2", &["SCRIPT_PLACEHOLDER"]),
    ("PTY", &["SCRIPT_PLACEHOLDER"]),
    ("QUIC", &["SCRIPT_PLACEHOLDER"]),
    ("RDP", &["SCRIPT_PLACEHOLDER"]),
    ("Reverse Shell", &["SCRIPT_PLACEHOLDER"]),
    ("RSS", &["SCRIPT_PLACEHOLDER"]),
    ("RTP", &["SCRIPT_PLACEHOLDER"]),
    ("RTSP", &["SCRIPT_PLACEHOLDER"]),
    ("SamlSp", &["SCRIPT_PLACEHOLDER"]),
    ("SIP", &["SCRIPT_PLACEHOLDER"]),
    ("SMB", &["SCRIPT_PLACEHOLDER"]),
    ("Snowflake", &["SCRIPT_PLACEHOLDER"]),
    ("SOCKET_FILE", &["SCRIPT_PLACEHOLDER"]),
    ("SOCKS5", &["SCRIPT_PLACEHOLDER"]),
    ("Spark", &["SCRIPT_PLACEHOLDER"]),
    ("SSH", &["SCRIPT_PLACEHOLDER"]),
    ("SSH Agent", &["SCRIPT_PLACEHOLDER"]),
    ("STDIO", &["SCRIPT_PLACEHOLDER"]),
    ("STUN", &["SCRIPT_PLACEHOLDER"]),
    ("SVN", &["SCRIPT_PLACEHOLDER"]),
    ("Syslog", &["SCRIPT_PLACEHOLDER"]),
    ("Telnet", &["SCRIPT_PLACEHOLDER"]),
    ("TFTP", &["SCRIPT_PLACEHOLDER"]),
    ("TLS", &["SCRIPT_PLACEHOLDER"]),
    ("Tor Relay", &["SCRIPT_PLACEHOLDER"]),
    ("Torrent-DHT", &["SCRIPT_PLACEHOLDER"]),
    ("Torrent-Peer", &["SCRIPT_PLACEHOLDER"]),
    ("Torrent-Tracker", &["SCRIPT_PLACEHOLDER"]),
    ("TURN", &["SCRIPT_PLACEHOLDER"]),
    ("UDP", &["SCRIPT_PLACEHOLDER"]),
    ...
    ("WebRTC Signaling", &["SCRIPT_PLACEHOLDER"]),
    ("WireGuard", &["SCRIPT_PLACEHOLDER"]),
    ("YARN", &["SCRIPT_PLACEHOLDER"]),
