...
The DoT client E2E tests verify LLM-controlled DNS query functionality over TLS-encrypted connections to public DoT servers. Tests focus on real-world scenarios using Google DNS (dns.google:853) and Cloudflare DNS (1.1.1.1:853).
...
**Example**: In `test_dot_client_multiple_queries`, LLM might send 3-5 queries depending on how it interprets "A, AAAA, and MX"
