...
This directory contains end-to-end tests for the VNC client implementation. Tests verify that the VNC client can connect to VNC servers, send pointer/key events, and handle framebuffer updates.
