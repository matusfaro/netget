...
Black-box E2E testing using DynamoDB Local or LocalStack for local testing. Tests verify the AWS SDK integration and DynamoDB operations work correctly.
