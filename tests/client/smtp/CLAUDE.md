...
E2E tests for the SMTP client verify email sending capabilities using a real SMTP server. Tests are designed to minimize LLM calls while ensuring robust functionality.
