...
The DoH client E2E tests verify DNS query functionality by connecting to **public DoH servers** (Google Public DNS,
Cloudflare DNS) and making real DNS queries. These are true end-to-end tests that validate:
