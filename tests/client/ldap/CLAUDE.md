...
Tests for the LDAP client protocol implementation. Tests use a real OpenLDAP server running in Docker and validate
LLM-controlled LDAP operations (bind, search, add, modify, delete).

## Test Strategy

**Black-box, prompt-driven testing** - LLM interprets prompts and performs LDAP operations, tests validate with real
OpenLDAP server.
