...
cargo test --features e2e-tests --test e2e_wireguard_test -- --test-threads=3

# OpenVPN honeypot
cargo test --features e2e-tests --test e2e_openvpn_test -- --test-threads=3

# IPSec honeypot
cargo test --features e2e-tests --test e2e_ipsec_test -- --test-threads=3
```
